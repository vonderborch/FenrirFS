...
namespace FenrirFS
{
    public interface IFileSystem
    {
        ...
        IFile CreateFile(IFolder directory, string name, CollisionOption collisionOption);

        IFile CreateFile(string path, CollisionOption collisionOption);

        Task<IFile> CreateFileAsync(string directory, string name, CollisionOption collisionOption, CancellationToken cancellationToken);

        Task<IFile> CreateFileAsync(IFolder directory, string name, CollisionOption collisionOption, CancellationToken cancellationToken);

        Task<IFile> CreateFileAsync(string path, CollisionOption collisionOption, CancellationToken cancellationToken);

        IFolder CreateFolder(string directory, string name, CollisionOption collisionOption);

        IFolder CreateFolder(IFolder directory, string name, CollisionOption collisionOption);

        IFolder CreateFolder(string path, CollisionOption collisionOption);

        Task<IFolder> CreateFolderAsync(string directory, string name, CollisionOption collisionOption, CancellationToken cancellationToken);

        Task<IFolder> CreateFolderAsync(IFolder directory, string name, CollisionOption collisionOption, CancellationToken cancellationToken);

        Task<IFolder> CreateFolderAsync(string path, CollisionOption collisionOption, CancellationToken cancellationToken);
