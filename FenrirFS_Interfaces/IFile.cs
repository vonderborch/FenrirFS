...
namespace FenrirFS
{
    ...
    public interface IFile : IDisposable, IEquatable<IFile>
    {
        ...
        bool ChangeExtension(string extension, FileCollisionOption collisionOption);

        Task<bool> ChangeExtensionAsync(string extension, FileCollisionOption collisionOption, CancellationToken cancellationToken);
        ...
        IFile Copy(string destination, FileCollisionOption collisionOption);

        IFile Copy(string destinationPath, string destinationName, FileCollisionOption collisionOption);

        Task<IFile> CopyAsync(string destination, FileCollisionOption collisionOption, CancellationToken cancellationToken);

        Task<IFile> CopyAsync(string destinationPath, string destinationName, FileCollisionOption collisionOption, CancellationToken cancellationToken);

        bool Delete();

        Task<bool> DeleteAsync(CancellationToken cancellationToken);

        bool Move(string destination, FileCollisionOption collisionOption);

        Task<bool> MoveAsync(string destination, FileCollisionOption collisionOption, CancellationToken cancellationToken);
        ...
        bool Rename(string name, FileCollisionOption collisionOption);

        Task<bool> RenameAsync(string name, FileCollisionOption collisionOption, CancellationToken cancellationToken);
