...
namespace FenrirFS
{
    public class FenrirFileSystem : AFileSystem
    {
        ...
        public override IFile CreateFile(string path, CollisionOption collisionOption)
        {
        ...
        public override IFile CreateFile(string directory, string name, CollisionOption collisionOption)
        {
        ...
        public override IFile CreateFile(IFolder directory, string name, CollisionOption collisionOption)
        {
        ...
        public override IFolder CreateFolder(string path, CollisionOption collisionOption)
        {
            Exceptions.NotNullOrEmptyCheck(path, nameof(path));
        ...
        public override IFolder CreateFolder(string directory, string name, CollisionOption collisionOption)
        {
            Exceptions.NotNullOrEmptyCheck(directory, nameof(directory));
            Exceptions.NotNullOrEmptyCheck(name, nameof(name));
        ...
        public override IFolder CreateFolder(IFolder directory, string name, CollisionOption collisionOption)
        {
            Exceptions.NotNullCheck<IFolder>(directory, nameof(directory));
            Exceptions.NotNullOrEmptyCheck(name, nameof(name));
